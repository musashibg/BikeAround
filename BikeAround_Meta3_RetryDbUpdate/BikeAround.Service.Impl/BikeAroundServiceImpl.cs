...
namespace BikeAround.Service.Impl
{
    ...
    public sealed class BikeAroundServiceImpl : IBikeAroundService, IRevertDbChanges
    {
        ...
        public User RegisterUser(User userDetails, [DoNotTrace] string password)
        {
            ...
            Data.User user = Context.Users.Create();
        ...
        public Bike RegisterBike(Bike bikeDetails, Guid bikeSecretIdentifier)
        {
            ...
            Data.Bike bike = Context.Bikes.Create();
        ...
        #region IRevertDbChanges Members

        void IRevertDbChanges.RevertChanges()
        {
            if (_context != null)
            {
                _context.Dispose();
