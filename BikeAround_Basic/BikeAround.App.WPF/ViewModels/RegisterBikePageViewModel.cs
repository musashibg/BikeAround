...
namespace BikeAround.App.ViewModels
{
    public sealed class RegisterBikePageViewModel : PageViewModelBase
    {
        ...
        public Guid? BikeSecretIdentifier
        {
            ...
            set
            {
                if (_bikeSecretIdentifier == value)
                {
                    return;
                }

                RaisePropertyChanging(nameof(BikeSecretIdentifier));
                _bikeSecretIdentifier = value;
                RaisePropertyChanged(nameof(BikeSecretIdentifier));
